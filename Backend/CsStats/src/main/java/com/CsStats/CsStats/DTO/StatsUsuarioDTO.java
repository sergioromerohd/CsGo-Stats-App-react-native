...
public class StatsUsuarioDTO {
        ...
        protected String timePlayedValue;
        protected String scoreValue;
        protected String kills;
        protected String deaths;
        protected String kd;
        protected String damage;
        protected String headshosts;
        protected String dominations;
        protected String shotsFired;
        protected String shotsHit;
        protected String shotsAccuracy;
        protected String snipersKilled;
        protected String dominationOverkills;
        protected String dominationRevenges;
        protected String bombsPlanted;
        protected String bombsDefused;
        protected String moneyEarned;
        protected String hostagesRescued;
        protected String mvp;
        protected String wins;
        protected String ties;
        protected String matchesPlayed;
        protected String losses;
        protected String roundsPlayed;
        protected String roundsWon;
        protected String wlPercentage;
        protected String headshotPct;
        ...
        public String toString() {
                return "Stats [id=" + id + ", user=" + user + ", avatar=" + avatar + ", statsID=" + statsID + ", id_usuario="
                                + id_usuario + ", timePlayedValue=" + timePlayedValue + ", scoreValue=" + scoreValue
                                + ", kills=" + kills + ", deaths=" + deaths + ", kd=" + kd + ", damage=" + damage
                                + ", headshosts=" + headshosts + ", dominations=" + dominations + ", shotsFired="
                                + shotsFired + ", shotsHit=" + shotsHit + ", shotsAccuracy=" + shotsAccuracy
                                + ", snipersKilled=" + snipersKilled + ", dominationOverkills=" + dominationOverkills
                                + ", dominationRevenges=" + dominationRevenges + ", bombsPlanted=" + bombsPlanted
                                + ", bombsDefused=" + bombsDefused + ", moneyEarned=" + moneyEarned + ", hostagesRescued="
                                + hostagesRescued + ", mvp=" + mvp + ", wins=" + wins + ", ties=" + ties
                                + ", matchesPlayed=" + matchesPlayed + ", losses=" + losses + ", roundsPlayed="
                                + roundsPlayed + ", roundsWon=" + roundsWon + ", wlPercentage=" + wlPercentage
                                + ", headshotPct=" + headshotPct + ", fecha=" + fecha + "]";
        }
